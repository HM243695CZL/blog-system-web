export const blogGatewayBaseApi = '/gateway/';

export const getBlogListApi = `${blogGatewayBaseApi}getBlogList`;
...
export const updateBlogViewsApi = `${blogGatewayBaseApi}updateBlogViews`;
